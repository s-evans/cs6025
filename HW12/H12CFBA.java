// H12CFBA.java CS6025 Yizong Cheng February 2015
// Implementing AES encryption with CFB mode, IV = 0, s = 8
// Usage: java H12CFBA key < original > encrypted

import java.io.*;
import java.util.*;

public class H12CFBA
{
    ...
    {
        if ( args.length < 1 ) {
            System.err.println( "Usage: java H12CFBA key < original > encrypted" );
            return;
        }

        H12CFBA h12 = new H12CFBA();
        h12.makeLog();
        h12.buildS();
        h12.readKey( args[0] );
        h12.expandKey();
