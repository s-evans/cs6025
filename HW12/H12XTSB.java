// H12XTSB.java CS6025 Yizong Cheng February 2015
// Implementing XTS-AES decryption
// Usage: java H12XTSB doublekey tweak > original < encrypted

import java.io.*;
import java.util.*;

public class H12XTSB
{
...
//         }
    ...
    {
        if ( args.length < 2 ) {
            System.err.println( "Usage: java H12XTSB doublekey tweak > original < encrypted" );
            return;
        }

        H12XTSB h12 = new H12XTSB();
        h12.makeLog();
        h12.buildS();
        h12.readKey( args[0] );
        h12.expandKey();
