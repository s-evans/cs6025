// H12OFBA.java CS6025 Yizong Cheng February 2015
// Implementing AES encryption with OFB mode
// Usage: java H12CFBA key nonce < original > encrypted

import java.io.*;
import java.util.*;

public class H12OFBA
{
    ...
    {
        if ( args.length < 2 ) {
            System.err.println( "Usage: java H12OFBA key nonce < original > encrypted" );
            return;
        }

        H12OFBA h12 = new H12OFBA();
        h12.makeLog();
        h12.buildS();
        h12.readKey( args[0] );
        h12.expandKey();
