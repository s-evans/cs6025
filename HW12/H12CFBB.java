// H12CFBB.java CS6025 Yizong Cheng February 2015
// Implementing AES decryption with CFB mode, IV = 0, s = 8
// Usage: java H12CFBB key > original < encrypted

import java.io.*;
import java.util.*;

public class H12CFBB
{
    ...
    {
        if ( args.length < 1 ) {
            System.err.println( "Usage: java H12CFBB key > original < encrypted" );
            return;
        }

        H12CFBB h12 = new H12CFBB();
        h12.makeLog();
        h12.buildS();
        h12.readKey( args[0] );
        h12.expandKey();
