// H12XTSA.java CS6025 Yizong Cheng February 2015
// Implementing XTS-AES encryption
// Usage: java H12XTSA doublekey tweak < original > encrypted

import java.io.*;
import java.util.*;

public class H12XTSA
{
...
//         }
    ...
    {
        if ( args.length < 2 ) {
            System.err.println( "Usage: java H12XTSA doublekey tweak < original > encrypted" );
            return;
        }

        H12XTSA h12 = new H12XTSA();
        h12.makeLog();
        h12.buildS();
        h12.readKey( args[0] );
        h12.expandKey();
        h12.readTweak( args[1] );
        h12.encrypt();
    }
}
