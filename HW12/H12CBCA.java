// H12CBCA.java CS6025 Yizong Cheng February 2015
// Implementing AES encryption with CBC mode, IV = 0
// Usage: java H12CBCA key < original > encrypted

import java.io.*;
import java.util.*;

public class H12CBCA
{
    ...
    {
        if ( args.length < 1 ) {
            System.err.println( "Usage: java H12CBCA key < original > encrypted" );
            return;
        }

        H12CBCA h12 = new H12CBCA();
        h12.makeLog();
        h12.buildS();
        h12.readKey( args[0] );
        h12.expandKey();
