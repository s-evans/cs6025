// H10A.java CS6025 Yizong Cheng February 2015
...
public class H10A
{
    ...
    static final int numberOfBits = 4; // 4 = log2(16)
    static final int fieldSize = 1 << numberOfBits; // = 2^numberOfBits
    static final int irreducible = 19; // log2(19) = 5; degree = 4
    static final int logBase = 14;
