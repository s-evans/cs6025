// H24.java CS6025 Yizong Cheng April 2015
...
public class H24
{
    ...
    void computeZ()
    {
        ...
        for ( int i = 0; i < locatorsLen; i++ ) {
            ...
            for ( int j = i + 1; j < locatorsLen; j++ ) {
                ...
                System.out.print( " " + locators[j] + " " + syndromes[j - i] + " " + Z[i] );
            }
    ...
    void computeErrorMagnitudes()
    {
        ...
        for ( int i = 0; i < maxErrors; i++ ) {
            ...
            e[i] = mul( evaluatePolynomial( Z, betaInverse[i] ), inverse( denominator ) );
        }
    ...
    public static void main( String[] args )
    {
        ...
        h24.getMatrix();
        h24.demask();
        h24.getDataBitStream();
        h24.addErrors();
        h24.computeSyndromes();
        h24.solveLocatorsBerlekampMassey();
        h24.solveErrorPositions();
        h24.computeZ();
        h24.computeErrorMagnitudes();
    }
